...
//
    ...
    self.assignSpoolToPrinter1 = function(){
        url = "http://192.168.215.13/plugin/SpoolManager/selectSpoolByQRCode/"+self.spoolItemForEditing.databaseId()+"?printerNumber=1";
        httpGet(url);
        self.closeDialogHandler(false, "selectSpoolForPrinting", self.spoolItemForEditing);      
        self.spoolItemForEditing.isSpoolVisible(false);
        self.spoolDialog.modal('hide');
    ...
    self.assignSpoolToPrinter2 = function(){
        url = "http://192.168.215.21/plugin/SpoolManager/selectSpoolByQRCode/"+self.spoolItemForEditing.databaseId()+"?printerNumber=2";
        httpGet(url);
        self.closeDialogHandler(false, "selectSpoolForPrinting", self.spoolItemForEditing);      
        self.spoolItemForEditing.isSpoolVisible(false);
        self.spoolDialog.modal('hide');
    ...
    self.assignSpoolToPrinter3 = function(){
        url = "http://192.168.215.47/plugin/SpoolManager/selectSpoolByQRCode/"+self.spoolItemForEditing.databaseId()+"?printerNumber=3";
        httpGet(url);
        self.closeDialogHandler(false, "selectSpoolForPrinting", self.spoolItemForEditing);      
        self.spoolItemForEditing.isSpoolVisible(false);
        self.spoolDialog.modal('hide');
    ...
    self.assignSpoolToPrinter4 = function(){
        url = "http://192.168.215.23/plugin/SpoolManager/selectSpoolByQRCode/"+self.spoolItemForEditing.databaseId()+"?printerNumber=4";
        httpGet(url);
        self.closeDialogHandler(false, "selectSpoolForPrinting", self.spoolItemForEditing);      
        self.spoolItemForEditing.isSpoolVisible(false);
        self.spoolDialog.modal('hide');
    ...
    self.assignSpoolToPrinter5 = function(){
        url = "http://192.168.215.25/plugin/SpoolManager/selectSpoolByQRCode/"+self.spoolItemForEditing.databaseId()+"?printerNumber=5";
        httpGet(url);
        self.closeDialogHandler(false, "selectSpoolForPrinting", self.spoolItemForEditing);      
        self.spoolItemForEditing.isSpoolVisible(false);
        self.spoolDialog.modal('hide');
